...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "Ranking de presencias · Club Vicentinos";
  const description = lider
    ? `${filas.length} jugadores. Líder histórico: ${lider.nombre}, con ${lider.total} presencias.`
    : `Ranking histórico de presencias, jugador por jugador.`;
